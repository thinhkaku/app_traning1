...
/**
 * Entity mapped to table SETTING_USER_ACCOUNT.
 */
public class SettingUserAccount {
    ...
    public SettingUserAccount() {
    }

    public SettingUserAccount(Integer ConfigCode) {
        this.ConfigCode = ConfigCode;
    }

    public SettingUserAccount(Integer ConfigCode, String Group, String Name, String Data, Long Record_Modified, Boolean Record_Upload) {
        this.ConfigCode = ConfigCode;
        this.Group = Group;
        this.Name = Name;
        this.Data = Data;
