...
/** 
 * DAO for table SETTING_CONFIG.
*/
public class SettingConfigDao extends AbstractDao<SettingConfig, Integer> {

    public static final String TABLENAME = "SETTINGCONFIG";

    /**
     * Properties of entity SettingConfig.<br/>
    ...
    */
    ...
    public SettingConfigDao(DaoConfig config) {
        super(config);
    }
    
    public SettingConfigDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'SETTINGCONFIG' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'SETTINGCONFIG'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, SettingConfig entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public SettingConfig readEntity(Cursor cursor, int offset) {
        SettingConfig entity = new SettingConfig( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, SettingConfig entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Integer updateKeyAfterInsert(SettingConfig entity, long rowId) {
        return entity.getConfigCode();
    }
    
    /** @inheritdoc */
    @Override
    public Integer getKey(SettingConfig entity) {
        if(entity != null) {
            return entity.getConfigCode();
        } else {
            return null;
