...
/**
 * Created by tuan.na on 5/25/2015.
 * Custom textview class: auto resize text size to fit a layout
 */
public class MccTextView extends TextView implements AutofitHelper.OnTextSizeChangeListener{

    private AutofitHelper mHelper;

    public MccTextView(Context context) {
        super(context);
        init(context, null, 0);
    }

    public MccTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public MccTextView(Context context, AttributeSet attrs, int defStyle) {
