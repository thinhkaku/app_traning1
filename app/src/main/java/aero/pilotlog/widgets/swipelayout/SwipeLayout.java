package aero.pilotlog.widgets.swipelayout;
...
public class SwipeLayout extends FrameLayout {
     ...
     * {@link aero.pilotlog.widgets.swipelayout.SwipeLayout.OnRevealListener}
     *
     ...
     * @param l        the {@link aero.pilotlog.widgets.swipelayout.SwipeLayout.OnRevealListener}
     */
    ...
    public boolean onTouchEvent(MotionEvent event) {
        //PL-910 can not touch to mScrollview
        if (getParent() instanceof IndexableListView) {
            IndexableListView mListView = (IndexableListView) getParent();
            if (mListView != null &&  mListView.getScroller()!=null &&  mListView.getScroller().getState() !=mListView.getScroller().STATE_HIDDEN){//mListView.getScroller().onTouchEvent(event)) {
     ...
     * {@link aero.pilotlog.widgets.swipelayout.SwipeLayout.ShowMode}.PullOut and
     * {@link aero.pilotlog.widgets.swipelayout.SwipeLayout.ShowMode}.LayDown.
     *
     * @param mode
     */
     ...
     * get the open status.
     *
     * @return {@link aero.pilotlog.widgets.swipelayout.SwipeLayout.Status} Open , Close or
     * Middle.
     */
